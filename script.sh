...
command="echo password | sudo -S docker cp /home/anurag/coderrank-query-execution-service/codes/Solution.java java-container:/home/ > /dev/null 2>/dev/null && echo password | sudo -S docker exec -i java-container java /home/Solution.java > /home/anurag/output.txt 2>/dev/null && cat /home/anurag/output.txt"
